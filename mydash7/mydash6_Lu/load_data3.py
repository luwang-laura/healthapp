...
def get_line(data_dict):
    ...
    row2 = html.Div([
        html.Div(
            children="The blue line shows the average weight changes with mother\'s age"  +  "\n The red line shows the overall baby's average weight",
            style={
                'textAlign': 'center',
                'color': colors['text']
            }),
...
def get_data3(file_name):
    ...
    return get_line(line), get_box(box_data), get_pie(des_data)
