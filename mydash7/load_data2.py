...
def get_show_KMeans(kmeans):
    ...
    row2 = html.Div([
        html.Div(
            children="Type 4 is the majority, it represents the older the mother is, the lighter the baby's weight",
            style={
                'textAlign': 'center',
                'color': colors['text']
            }),
...
def get_result_plot(data):
    ...
    #########################Compare Metrix Color
    color_list = px.colors.sequential.Agsunset
    #color_list = px.colors.sequential.RdBu
