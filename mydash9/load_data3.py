...
##############Box Plot
    row2 = html.Div([
        html.Div(
            children="Please pay attention to the outliers in the first box."+"\nThe dataset in the second box is relatively discrete."
            +"\nThese two boxes do not make too much difference.",
            style={
                'textAlign': 'center',
                'color': colors['text']
            }),
