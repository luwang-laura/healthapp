...
def Model_data(data2: pd.DataFrame):
    ...
    return Roc_data, test_df, x_list, y_list, name_list
...
def get_auc_plot(name_list, x_list, y_list):
    fig = go.Figure()
    fig.add_shape(
...
def get_data2(file_name):
    ...
    return get_show_KMeans(kmeans), get_auc_plot(name_list, x_list, y_list), get_result_plot(test_df)
